...
class ChordDrawer {
    constructor(element, options) {
        ...
        this.riffWidth = this.data.chordLength * this.stringHorizontalMargin;
        ...
        console.log('riffWidth', this.riffWidth)
        console.log('svgWith', this.svgWidth)
    }
        ...
        for (let i = 0, length = this.data.chord.length; i < length; i++) {
            ...
            switch (item.type) {
                case 'clamp':
                    ...
                    break;
                case 'barre':
                    this._drawBarre(1, item.barre.from, item.barre.to);
                    break;
            }
        }
